...
WebUI.setText(findTestObject('Object Repository/Page_Facebook  log in or sign up/input_Facebook helps you connect and share _ccef60'), 
    'yuliwulandari257@gmail.com')

WebUI.click(findTestObject('Object Repository/Page_Facebook  log in or sign up/div_Facebook helps you connect and share wi_4680ca'))
